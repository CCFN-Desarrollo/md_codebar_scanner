...
class _PasswordScreenState extends State<PasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // Esta propiedad evita que el body se redimensione cuando aparece el teclado
      ...
      body: Container(
        ...
        child: SafeArea(
          // Usar SingleChildScrollView para hacer scrollable el contenido
          child: SingleChildScrollView(
            // Opcional: mantener el padding del teclado
            keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
            child: Container(
              // Usar la altura mínima de la pantalla menos la app bar
